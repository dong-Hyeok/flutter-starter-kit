...
/// -[isEnable]: 버튼 활성화 옵션
/// -[onTap]: 버튼 클릭 이벤트
class LinkMicroSecondaryButton extends StatefulWidget {
  final String title;
  ...
  const LinkMicroSecondaryButton({
    required this.title,
    this.assetName,
  ...
  @override
  State<LinkMicroSecondaryButton> createState() => _LinkMicroSecondaryButtonState();
}

class _LinkMicroSecondaryButtonState extends State<LinkMicroSecondaryButton> {
  ...
  List<Widget> _buildLeftIconLayout() {
    return [
      ...
      Text(
        widget.title,
        style: TextStyles.Link3.copyWith(
          color:
              _isPressed
